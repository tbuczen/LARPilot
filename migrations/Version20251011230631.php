...
final class Version20251011230631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE character_tags DROP CONSTRAINT larp_character_tags_pkey');
        ...
        $this->addSql('ALTER TABLE character_faction DROP CONSTRAINT larp_character_larp_faction_pkey');
        ...
        $this->addSql('ALTER TABLE character_faction ADD PRIMARY KEY (character_id, faction_id)');
        ...
        $this->addSql('ALTER TABLE event_character DROP CONSTRAINT event_larp_character_pkey');
        ...
        $this->addSql('ALTER TABLE event_character ADD PRIMARY KEY (event_id, character_id)');
        ...
        $this->addSql('ALTER TABLE event_faction DROP CONSTRAINT event_larp_faction_pkey');
        ...
        $this->addSql('ALTER TABLE event_faction ADD PRIMARY KEY (event_id, faction_id)');
